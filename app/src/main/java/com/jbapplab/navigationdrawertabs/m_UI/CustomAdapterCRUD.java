...
public class CustomAdapterCRUD extends RecyclerView.Adapter<MyViewHolderCRUD> {
    ...
    public void onBindViewHolder(MyViewHolderCRUD holder, int position) {
        ...
        holder.storyId.setText(story.getStoryId());
        ...
        holder.authorId.setText(story.getAuthorId());
        ...
        holder.setItemClickListener(new StoryItemClickListener() {
            ...
            public void onItemClick() {
                openStoryDetailActivityCRUD(story.getStoryId(), story.getStoryTitle(), story.getStoryCategory(), story.getIfOtherSpecify(), story.getAuthorId(), story.getStoryDescription(), story.getStoryEvents(), story.getOrientation(), story.getComplicatedAction(), story.getEvaluation(), story.getResolution(), story.getMessage(), story.getStoryMeta(), story.getStageRelated(), story.getContextRelated(), story.getStoryFull(), story.getAudienceStage(), story.getImageUrl());
            }
        });
