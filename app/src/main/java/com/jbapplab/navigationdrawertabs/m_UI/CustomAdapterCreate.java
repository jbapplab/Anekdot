...
public class CustomAdapterCreate extends BaseAdapter {
    Context context;
    ArrayList<Category> categories;

    public CustomAdapterCreate(Context context, ArrayList<Category> categories) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup){
        ...
        if (view==null) {
            view = LayoutInflater.from(context).inflate(R.layout.create_item, viewGroup, false);
        }

        final Category category = (Category) this.getItem(i);

        ImageView categoryImageView = view.findViewById(R.id.createImage);
        TextView categoryNameTextView = view.findViewById(R.id.createName);
